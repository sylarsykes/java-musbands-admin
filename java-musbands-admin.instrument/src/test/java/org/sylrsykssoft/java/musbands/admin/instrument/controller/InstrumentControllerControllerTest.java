...
import static org.sylrsykssoft.java.musbands.admin.instrument.configuration.InstrumentConstants.CONTROLLER_GET_FIND_ALL_BY_EXAMPLE;
import static org.sylrsykssoft.java.musbands.admin.instrument.configuration.InstrumentConstants.CONTROLLER_GET_FIND_ALL_BY_EXAMPLE_SORTABLE;
import static org.sylrsykssoft.java.musbands.admin.instrument.configuration.InstrumentConstants.CONTROLLER_GET_FIND_BY_EXAMPLE;
import static org.sylrsykssoft.java.musbands.admin.instrument.configuration.InstrumentConstants.CONTROLLER_GET_FIND_BY_ID;
import static org.sylrsykssoft.java.musbands.admin.instrument.configuration.InstrumentConstants.CONTROLLER_GET_FIND_BY_NAME_MAPPING;
...
public class InstrumentControllerControllerTest {
	...
	public void setUp() {
		...
		domainForUdpate = InstrumentResource.instrumentResourceBuilder().entityId(3).name(name)
				.description(description + " erop").build();
	}
	...
	public void testFindAll() throws Exception {
		...
		// when(musicalGenreService.findAll()).thenReturn(Arrays.asList(new
		// InstrumentResource()));
