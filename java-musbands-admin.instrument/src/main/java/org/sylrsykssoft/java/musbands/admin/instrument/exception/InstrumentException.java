package org.sylrsykssoft.java.musbands.admin.instrument.exception;
...
public class InstrumentException extends CoreApiFrameworkLibraryException {
	...
	public InstrumentException(final String message, final Throwable cause) {
		super(message, cause);
	}
	...
	public InstrumentException(final Throwable cause) {
		super(cause);
	}
