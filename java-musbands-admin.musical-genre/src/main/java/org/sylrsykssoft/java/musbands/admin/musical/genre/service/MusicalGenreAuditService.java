...
import org.sylrsykssoft.java.musbands.admin.musical.genre.repository.MusicalGenreAuditRepository;
...
/**
 * MusicalGenreAuditService Service.
 * 
...
public class MusicalGenreAuditService extends BaseAdminAuditService<MusicalGenre, MusicalGenreAuditResource> {
	...
	@Autowired
	private MusicalGenreAuditRepository musicalGenreRepository;
	 ...
	 */
	@Override
	public MusicalGenreAuditRepository getAdminRepository() {
